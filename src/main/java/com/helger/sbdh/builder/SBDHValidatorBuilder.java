 ...
 */
@NotThreadSafe
public class SBDHValidatorBuilder <JAXBTYPE> extends JAXBValidationBuilder <JAXBTYPE, SBDHValidatorBuilder <JAXBTYPE>>
{
  public SBDHValidatorBuilder (@Nonnull final ESBDHDocumentType eDocType)
  {
    super (eDocType);
  }

  public SBDHValidatorBuilder (@Nonnull final Class <JAXBTYPE> aClass)
  {
